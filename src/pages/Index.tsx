...
const Index = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-6 md:p-12 bg-slate-950">
      <div className="w-full max-w-3xl mx-auto space-y-10">
        <header className="text-center space-y-6 animate-slide-up">
          <div className="flex items-center justify-center gap-4 mb-6">
            <Sparkles className="w-8 h-8 text-primary animate-pulse" />
            <h1 className="text-3xl md:text-4xl lg:text-5xl bg-clip-text bg-gradient-to-r from-primary via-accent to-primary leading-tight font-extrabold text-center text-slate-300">
              MindSpark
            </h1>
            <Sparkles className="w-8 h-8 text-accent animate-pulse" />
          </div>
          <p className="text-xs leading-relaxed max-w-2xl mx-auto px-4 md:text-sm font-normal text-orange-200">
        ...
        <IdeaCard idea={currentIdea} category={category} className="bg-neutral-700" />
